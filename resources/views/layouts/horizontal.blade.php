        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item waves-effect" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    ...
                    @default
                    @case('id')
                    <img src="{{ URL::asset('build/images/flags/indonesia.png')}}" alt="Header Language" height="16"> <span class="align-middle">Indoneisa</span>
                    @endswitch
                </button>
            ...
            <div class="dropdown d-inline-block">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    <!-- item-->
                    <a class="dropdown-item" href="profile"><i class="bx bx-user font-size-16 align-middle me-1"></i> <span key="t-profile">@lang('translation.Profile')</span></a>
                        ...
                        <div class="dropdown-menu" aria-labelledby="topnav-pages">
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-contact">
                                    ...
                                    <a href="profile" class="dropdown-item" key="t-profile">@lang('translation.Profile')</a>
                                </div>
                            </div>
